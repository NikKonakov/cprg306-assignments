export default function Page(){
    return(
        <main class="m-8 p-4 w-3/4">
            <h1 class="text-blue-700 text-4xl">CPRG 306: Web Development 2 - Assignments</h1>
            <h2 class="text-2xl text-indigo-800 text-pretty mt-4 ml-4"><ul>Assignments</ul></h2>
            <div class="text-indigo-500 ml-8 mt-2">
                ...
                <li><a href="./week-5" class="hover:font-bold hover:font-serif hover:text-indigo-900">Week 5 Assignment</a></li>
            </div>
        </main>
    );
}